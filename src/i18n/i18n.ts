...
const translations: Record<LocaleCode, Translations> = {
  ...
  ar: {
    ...
    'phrase.sovereigntyDuty':   'Configurable execution modes',
    'phrase.tagline':           'Arabic-language model orchestration',
    'phrase.taglineAr':         'NIYAH model orchestration',
    'phrase.poweredByOllama':   'Configured model provider',
    'phrase.localInference':    'Configured model inference',
    'phrase.noDataLeaks':       'Data handling settings',
    'phrase.yourCodeYoursAlone':'Project workspace',
